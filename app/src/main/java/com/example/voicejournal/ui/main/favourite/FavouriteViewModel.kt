...
@HiltViewModel
class FavouriteViewModel @Inject constructor(private val voiceJournalRepository: VoiceJournalRepositoryImpl) : ViewModel() {
    ...
    private fun getNotes(){
        viewModelScope.launch {
            voiceJournalRepository.getAllVoiceJournals()
               /* .collect{it->
              val sortedList =      it.filter { it.favourite==true }
